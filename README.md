...
A begin and rescue statement will wrap the menu loop to diplay a custom error message for errors not otherwise addressed by method-specific if/else statements.
